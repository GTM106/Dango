...
class DangoRole
{
    ...
    private DangoRole()
    {
        posRoles = new()
    {
        new Role<int>(new int[]{0,0,0},POSROLE_MONOCOLOR,18),
        new Role<int>(new int[]{0,0,0,0},POSROLE_MONOCOLOR,22),
        new Role<int>(new int[]{0,0,0,0,0},POSROLE_MONOCOLOR,27),
        new Role<int>(new int[]{0,0,0,0,0,0},POSROLE_MONOCOLOR,31),
        new Role<int>(new int[]{0,0,0,0,0,0,0},POSROLE_MONOCOLOR,36),
        new Role<int>(new int[]{0,1,0},POSROLE_LINE_SYMMETRY,13),
        new Role<int>(new int[]{0,1,1,0},POSROLE_LINE_SYMMETRY,18),
        new Role<int>(new int[]{0,0,1,0,0},POSROLE_LINE_SYMMETRY,22),
        new Role<int>(new int[]{0,1,0,1,0},POSROLE_LINE_SYMMETRY,22),
        new Role<int>(new int[]{0,1,1,1,0},POSROLE_LINE_SYMMETRY,22),
        new Role<int>(new int[]{0,1,2,1,0},POSROLE_LINE_SYMMETRY,22),
        new Role<int>(new int[]{0,0,1,1,0,0},POSROLE_LINE_SYMMETRY,27),
        new Role<int>(new int[]{0,1,0,0,1,0},POSROLE_LINE_SYMMETRY,27),
        new Role<int>(new int[]{0,1,1,1,1,0},POSROLE_LINE_SYMMETRY,27),
        new Role<int>(new int[]{0,1,2,2,1,0},POSROLE_LINE_SYMMETRY,27),
        new Role<int>(new int[]{0,0,0,1,0,0,0},POSROLE_LINE_SYMMETRY,31),
        new Role<int>(new int[]{0,0,1,0,1,0,0},POSROLE_LINE_SYMMETRY,31),
        new Role<int>(new int[]{0,0,1,1,1,0,0},POSROLE_LINE_SYMMETRY,31),
        new Role<int>(new int[]{0,0,1,2,1,0,0},POSROLE_LINE_SYMMETRY,31),
        new Role<int>(new int[]{0,1,0,0,0,1,0},POSROLE_LINE_SYMMETRY,31),
        new Role<int>(new int[]{0,1,0,1,0,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,0,2,0,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,1,0,1,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,1,1,1,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,1,2,1,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,2,0,2,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,2,1,2,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,2,2,2,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,2,3,2,1,0},POSROLE_LINE_SYMMETRY, 31),
        new Role<int>(new int[]{0,1,0,1},POSROLE_LOOP,18),
        new Role<int>(new int[]{0,0,1,0,0,1},POSROLE_LOOP,27),
        new Role<int>(new int[]{0,1,1,0,1,1},POSROLE_LOOP,27),
        new Role<int>(new int[]{0,1,2,0,1,2},POSROLE_LOOP,27),
        new Role<int>(new int[]{0,1,0,1,0,1},POSROLE_LOOP,27),
        new Role<int>(new int[]{0,0,1,1},POSROLE_DIVIDED_INTO_TWO,18),
        new Role<int>(new int[]{0,0,0,1,1,1},POSROLE_DIVIDED_INTO_TWO,27),
        new Role<int>(new int[]{0,0,1,1,2,2},POSROLE_DIVIDED_INTO_THREE,27),
    };
    }
