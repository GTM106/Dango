...
public class Stage003Data : StageData
{
    ...
    protected override void AddQuest()
    {
        ...
        {
            questManager.Creater.CreateQuestCreateRole(0, new QuestCreateRole.CreateSameRole(false), 1, 4, "異なる団結を4回連続で作る", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "すごいぞ！色々な団結を作れるようになったな", 5f, PortraitTextData.FacePatturn.Fun)),
                1,2),

            questManager.Creater.CreateQuestPlayAction(1, QuestPlayAction.PlayerAction.FallAttack, 2, "急降下刺しで2回刺す", 10f, false, false, new(
                ...
                3),
            questManager.Creater.CreateQuestDestination(2, FloorManager.Floor.floor8, false, "上に向かえ", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "どんどん行くぜ、目指せ最上階！", 5f, PortraitTextData.FacePatturn.Fun)),
                3),

            //D5上昇
            questManager.Creater.CreateQuestCreateRole(3, new QuestCreateRole.SpecifyTheRole("一統団結"), 1, 0, "一種類だけで団結を作れ", 10f, true, false, new(
                new PortraitTextData.PTextData(0, "一意専心。ただ真っ直ぐに、俺の道を征く！", 5f, PortraitTextData.FacePatturn.Fun)),
                4),

            //D5上昇
            questManager.Creater.CreateQuestCreateRole(4, new QuestCreateRole.EstablishRole(true, false, DangoColor.An), 3, 0, "あん団子を含んで団結を3回作れ", 10f, true, false, new(
                new PortraitTextData.PTextData(0, "あん団子で団結を作るのも慣れてきたな", 5f, PortraitTextData.FacePatturn.Normal)),
                5),

            questManager.Creater.CreateQuestDestination(5, FloorManager.Floor.floor12, false, "城内の上層に向かえ", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "あと少しで最上階！待ってろよ伝説の団子！", 5f, PortraitTextData.FacePatturn.Happy)),
                6,7),

            questManager.Creater.CreateQuestCreateRole(6, new QuestCreateRole.CreateSameRole(true), 1, 2, "同じ団結を2回連続で作る", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "見つけたぜ、自分の団結ってやつを", 5f, PortraitTextData.FacePatturn.Fun)),
                8),
            questManager.Creater.CreateQuestCreateRole(7, new QuestCreateRole.CreateSameRole(false), 1, 2, "異なる団結を2回連続で作る", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "変化のない人生なんてつまらねぇよな！", 5f, PortraitTextData.FacePatturn.Happy)),
                8),

            //D5上昇
            questManager.Creater.CreateQuestCreateRole(8, new QuestCreateRole.SpecifyTheRole("三面華鏡"), 2, 0, "三分割で団結を2回作れ", 10f, true, false, new(
                new PortraitTextData.PTextData(0, "こんな団結もあったんだな！俺もまだまだだぜ", 5f, PortraitTextData.FacePatturn.Fun)),
                9),

            questManager.Creater.CreateQuestCreateRole(0, new QuestCreateRole.EstablishRole(true, false), 1, 0, "何らかの団結を成立させる", 10f, false, false, new(
                new PortraitTextData.PTextData(0, "流儀を以て団子を食す、それ即ち団道なり！", 5f, PortraitTextData.FacePatturn.Fun)),
                10),

            questManager.Creater.CreateQuestDestination(10, FloorManager.Floor.floor15, false, "城内の最上層に向かえ", 10f, false, true, new(
