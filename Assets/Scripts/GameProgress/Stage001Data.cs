...
public class Stage001Data : StageData
{
    ...
    protected override void AddQuest()
    {
        ...
        List<QuestData> quest = new()
        {
            questManager.Creater.CreateQuestCreateRole(0, new QuestCreateRole.EstablishRole(true, false), 1, 0, "何らかの団結を成立させる", 30f, false, false,new(
                new PortraitTextData.PTextData(0,"団結を作ったな！",5f,PortraitTextData.FacePatturn.Normal),
                new(0,"お腹も膨れて一石二鳥！この調子でいこう！",5f,PortraitTextData.FacePatturn.Normal)),
                2),
            questManager.Creater.CreateQuestCreateRole(1, new QuestCreateRole.EstablishRole(false, false), 1, 0, "団結を成立させずに団子を食べる", 15f, false, false,new(
                new PortraitTextData.PTextData(0,"美味い！やっぱ栄都の団子は違うねぇ",5f,PortraitTextData.FacePatturn.Normal),
            ...
            questManager.Creater.CreateQuestCreateRole(2, new QuestCreateRole.SpecifyTheRole("全天鏡面"), 2, 0, "線対称で団結を2回作れ", 30f, true, false, new(
                new PortraitTextData.PTextData(0, "しんめとりい、ってやつだな！", 5f, PortraitTextData.FacePatturn.Normal),
                new(1, "串が伸びたぜ。これで上に行けるようになったか……？", 5f, PortraitTextData.FacePatturn.Normal)),
                3),

            questManager.Creater.CreateQuestDestination(3, FloorManager.Floor.floor8, false, "上に向かえ", 30f, false, false, new(
                new PortraitTextData.PTextData(0, "ふぅー、高いねぇ！", 5f, PortraitTextData.FacePatturn.Normal),
                new(1, "まだまだ上がありそうだな", 5f, PortraitTextData.FacePatturn.Normal)),
                4,5),
            ...
            questManager.Creater.CreateQuestCreateRole(4, new QuestCreateRole.EstablishRole(true, false, DangoColor.Mitarashi), 2, 0, "みたらし団子を含んで団結を2回作れ", 30f, false, false, new(
                new PortraitTextData.PTextData(0, "みたらし団子は美味いなぁ！", 5f, PortraitTextData.FacePatturn.Normal),
            ...
            questManager.Creater.CreateQuestCreateRole(6, new QuestCreateRole.CreateSameRole(false),1,2,"異なる団結を2回連続で作る", 30f,true,false,new(
                ...
                new(1, "折角なら色々な食べ合わせを楽しまねぇとな！", 5f, PortraitTextData.FacePatturn.Normal)),
                7),
            ...
            questManager.Creater.CreateQuestDestination(7, FloorManager.Floor.floor9, false, "上に向かえ", 0f, false, true,new(
                ...
                new(1, "ここらで少し休憩にするか！", 5f, PortraitTextData.FacePatturn.Normal),
                new(2, "団道完了！", 5f, PortraitTextData.FacePatturn.Normal)),
            8),
    ...
    {
        return new(new PortraitTextData.PTextData(0, "団道を始めるぜ！", 5f, PortraitTextData.FacePatturn.Normal), new(0, "まずはクエストの確認からだな…", 5f, PortraitTextData.FacePatturn.Normal), new(0, "Lボタンを押してみようぜ！", 10f, PortraitTextData.FacePatturn.Normal));
    }
