...
public class StageTutorialData : StageData
{
    ...
    protected override void AddQuest()
    {
        ...
        List<QuestData> quest = new()
        {
            ...
            questManager.Creater.CreateQuestDestination(0, FloorManager.Floor.floor2, false, "移動して先に進め", 0f, false, false, new(
                ...
                new(1, "現在の目標はXボタンかLボタンで確認できるからな", 0f, PortraitTextData.FacePatturn.Normal),
            ...
            questManager.Creater.CreateQuestPlayAction(1,QuestPlayAction.PlayerAction.Look,0,"「社」を探せ",0f,false,false,new(
                ...
                new(1, "次は高跳びアクションの練習だ。Aボタンで出来るぜ", 0f, PortraitTextData.FacePatturn.Normal),
            ...
            questManager.Creater.CreateQuestDestination(2, FloorManager.Floor.floor3, false, "高台に向かえ", 0f, false, false, new(
                ...
                new PortraitTextData.PTextData(3, "団子を正面に捉えてBボタンで団子を刺すことが出来るぜ！", 0f, PortraitTextData.FacePatturn.Fun),
            ...
            questManager.Creater.CreateQuestPlayAction(3,QuestPlayAction.PlayerAction.Stab,3,"3回団子を刺す", 0f,false, false,new(
                ...
                new(4, "と思ったが、今は串がいっぱいだな、Rトリガー長押しで団子を外してみようぜ", 0f, PortraitTextData.FacePatturn.Fun)),
                4),

            questManager.Creater.CreateQuestPlayAction(4, QuestPlayAction.PlayerAction.RemoveAnyPlace, 1, "1回団子を外す", 0f, false, false, new(
                new PortraitTextData.PTextData(0, "オーケーだ", 5f, PortraitTextData.FacePatturn.Fun),
                ...
                new PortraitTextData.PTextData(3, "完成したらLトリガー長押しで食べる！団結が出来てれば成功だ！", 5f, PortraitTextData.FacePatturn.Happy)),
                5),
            ...
            questManager.Creater.CreateQuestCreateRole(5, new QuestCreateRole.SpecifyTheRole("全天鏡面"), 1, 0, "線対称で団結を作れ", 0f, false, true, new(
                ...
                new(1, "団結を作れば腹も膨れて制限時間がもらえる、だからどんどん団結を作るんだぜ！", 0f, PortraitTextData.FacePatturn.Fun),
                new(2, "基本操作は以上だ、まだ知りたいことがあったら他の初心者指南も受けてみてくれ", 0f, PortraitTextData.FacePatturn.Normal),
                new(3, "それじゃあ、団道完了だぜ！", 0f, PortraitTextData.FacePatturn.Happy)),
    ...
    {
        return new(new(0, "流儀を以て団子を食す、ようこそ！団道へ", 2f, PortraitTextData.FacePatturn.Fun),
